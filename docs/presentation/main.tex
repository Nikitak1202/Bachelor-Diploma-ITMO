...
\begin{frame}{Цель и задачи}
    ...
    \textbf{Задачи.}
    \begin{enumerate}
        \item Развернуть воспроизводимую среду тестирования и настройки алгоритмов управления
              (Docker, ROS\,2, Gazebo).
        \item Реализовать модель робота, узлы восприятия, планирования, картирования и управления.
